...
import os
API_KEY="AIzaSyCnHFjJJv7yn15eds-l40d5_K3UN82oKDo"

GRANDPY_EMPTY = [
    "Je me suis transformé en cornichon. Je suis Rickornichoooon"
]
GRANDPY_DONT_UNDERSTAND = [
    "La réponse est: n'y pensez même pas."
]

GRANDPY_KNOWS = [
    "Nous avons peut-être établi des relations entre des choses qui n'étaient pas du tout liées."
]
